...
#include "custom_interfaces/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox__ros_msg_type = custom_interfaces__msg__BoundingBox;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: size
  {
    ...
    if (ros_message->size.data) {
      geometry_msgs__msg__Point__Sequence__fini(&ros_message->size);
    }
    if (!geometry_msgs__msg__Point__Sequence__init(&ros_message->size, size)) {
...
size_t get_serialized_size_custom_interfaces__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBox__ros_msg_type * ros_message = static_cast<const _BoundingBox__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__BoundingBox(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__BoundingBox(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, msg, BoundingBox)() {
