...
static rosidl_typesupport_introspection_c__MessageMember custom_interfaces__msg__PersonPose__rosidl_typesupport_introspection_c__PersonPose_message_member_array[4] = {
  {
    "header",  // name
