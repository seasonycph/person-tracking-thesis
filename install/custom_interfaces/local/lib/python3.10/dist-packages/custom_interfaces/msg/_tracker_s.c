...
bool custom_interfaces__msg__tracker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._tracker.Tracker", full_classname_dest, 38) == 0);
  }
  custom_interfaces__msg__Tracker * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Tracker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._tracker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tracker");
