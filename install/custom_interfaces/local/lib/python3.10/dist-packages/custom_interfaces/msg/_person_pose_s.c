...
bool custom_interfaces__msg__person_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // kpt_conf
    PyObject * field = PyObject_GetAttrString(_pymsg, "kpt_conf");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->kpt_conf.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'kpt_conf'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // person_position
    PyObject * field = PyObject_GetAttrString(_pymsg, "person_position");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'person_position'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Point * dest = ros_message->person_position.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
  ...
  {  // looking
    PyObject * field = PyObject_GetAttrString(_pymsg, "looking");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->looking.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'looking'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of PersonPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._person_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PersonPose");
  ...
  {  // kpt_conf
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "kpt_conf");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->kpt_conf.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->kpt_conf.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->kpt_conf.size * sizeof(float));
      assert(data != NULL);
  ...
  {  // person_position
    ...
    geometry_msgs__msg__Point * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->person_position.data[i]);
      PyObject * pyitem = geometry_msgs__msg__point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "person_position", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // looking
    ...
    bool * src = ros_message->looking.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "looking", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
